...
export function getComparator(order: string, orderBy: string): (a: any, b: any) => number {
  return order === 'desc'
    ? (a, b) => descendingComparator(a, b, orderBy)
    : (a, b) => -descendingComparator(a, b, orderBy);
}

export function applyFilter({ inputData, comparator, filterName }: { inputData: any[], comparator: (a: any, b: any) => number, filterName: string }): any[] {
